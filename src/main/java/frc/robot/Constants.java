...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final double speedFactor = 0.5; //0.7 for mark
    public static final double turningFactor = 0.4; //0.6 for mark
...
//FIND NEW ENCODERSETPOINT FOR ALGAEPIVOT
  ...
  public static final class AlageRollerConstants {
    ...
    public static final double ALAGE_ROLLER_INTAKE = -0.50;
